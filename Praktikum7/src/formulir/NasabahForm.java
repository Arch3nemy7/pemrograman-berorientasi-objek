 ...
 * @author bagas
 */
public class NasabahForm extends javax.swing.JFrame {
     ...
     */
    public NasabahForm(LoginForm loginForm, Bank bank) {
        initComponents();
        this.loginForm = loginForm;
        this.bank = bank;
        this.jumlahNasabah = bank.getJumlahNasabah();
        
        txtNama.setText(bank.getNasabah(jumlahNasabah - 1).getNamaAwal()+ " " + bank.getNasabah(jumlahNasabah - 1).getNamaAkhir());
        txtSaldo.setText("Rp" + bank.getNasabah(jumlahNasabah - 1).getTabungan().getSaldo());
    }
    ...
    private void btnDepositActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDepositActionPerformed
            ...
            bank.getNasabah(jumlahNasabah - 1).getTabungan().simpanUang(Integer.parseInt(inputSaldo.getText()));
    ...
    private void btnTarikActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTarikActionPerformed
            ...
            bank.getNasabah(jumlahNasabah - 1).getTabungan().ambilUang(Integer.parseInt(inputSaldo.getText()));
